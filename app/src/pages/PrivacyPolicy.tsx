...
export default function PrivacyPolicy() {
    useEffect(() => {
        ...
        document.title = 'Privacy Policy | Cornerstone Research';
        const m = document.querySelector<HTMLMetaElement>('meta[name="description"]');
        const pd = m?.content ?? '';
        if (m) m.content = 'Read how Cornerstone Research protects your personal data, manuscript confidentiality, and your rights under GDPR and applicable privacy laws.';
                ...
                <div className="space-y-8 text-gray-700 leading-relaxed">
                    ...
                    <section className="pt-8 border-t border-slate-100 mt-10">
                        <p className="text-sm text-slate-500 italic text-center">
                            If you have any privacy-related questions or concerns, please contact us at <br/>
